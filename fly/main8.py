...
import supply
from random import *
from fly.supply import Bomb_Supply
...
def main():
    ...
    # 标志时候暂停游戏
    paused = False
    pause_nor_image = pygame.image.load("images/pause_nor.png").revert_alpha()
    pause_pressed_image = pygame.image.load("images/pause_pressed.png").revert_alpha()
    resume_nor_image = pygame.image.load("images/resume_nor.png").revert_alpha()
    resume_pressed_image = pygame.image.load("images/resume_pressed.png").revert_alpha()
    paused_rect = pause_nor_image.get_rect()
    paused_rect.left, paused_rect.top = paused_rect.width - 10, 10
        ...
        if not paused:
            ...
            if not(delay % 10):
                ...
                if is_double_bullet:
                    ...
                    bullet2_index = (bullet1_index + 2) % BULLET2_NUM
                else:
                    bullets = bullet1
            ...
            screen.blit(bomb_text, (20 + bomb_rect, height -5 - text_rect.height))
